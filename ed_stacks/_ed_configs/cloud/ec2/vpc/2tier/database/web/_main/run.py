def run(instructargs):
    ...
    cli = stack.new_builtin_cmd("ec2 vpc create")
    cli.order_type = "create-cloudvpc::api"
    cli.role = "cloud/network"
    cli.human_description = "Creates VPC {}".format(stack.vpc)
    cli.display = True
    ...
    inputargs["rules"] = "gary:::public::firewall/web \
    ...
    inputargs["rules"] = "gary:::public::firewall/web_public \
    ...
    stack.create_builtin_cmd("ec2 security group activate",
